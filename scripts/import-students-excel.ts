...
async function main() {
  ...
  for (let i = 0; i < rows.length; i++) {
    ...
    const class302Codes = new Set([
      '929333462', // محمدامین پورطالبی
      '929815791', // سجاد خزاعی
      '929539591', // محمد پارسا رحمانی
      '929514653', // محمدمتین رمضانی
      '960003691', // امیرعلی شایسته
      '929438991', // صدرا شیرزاد مقدم
      '929488148', // سپهر عافیت
      '929829662', // امیرحسین غزنوی
      '929844629', // امیرعلی قاسم پور
      '929502442', // طاها قاسمی
      '929320360', // متین قانعی
      '201569329', // سبحان قدمگاهی
      '970030681', // امیرعلی قراگزلو
      '929438272', // متین کامل
      '970018037', // داریوش مومنی پور
      '929493524', // امیرعلی مجاهدی فر
      '928976726', // ایلیا معتمد مقدم
      '9402006727', // ابوالفضل موسوی
      '6420024730', // امیر محمد باقری
    ]);
    ...
    if (gradeLevel === 'یازدهم') {
      ...
      targetClass = class302Codes.has(studentUsername) ? class302 : class301;
    }
